...
2. What is the probability of being given drug C?
   ...
   SOLUTION: $$\mathbb{P}(C) = \mathbb{P}(C \vert B) + \mathbb{P}\left(C \vert \overline{B}\right) = \frac{52}{1000} + \frac{148}{1000} = \frac{200}{1000} = \frac{1}{5}$$.
...
2. Getting a Queen and a Jack?
   ...
   SOLUTION: $$\mathbb{P}(Q \cup J) = \mathbb{P}(Q \text{ then } J) + \mathbb{P}(J \text{ then } Q) = \left(\frac{1}{13} + \frac{1}{12}\right) + \left(\frac{1}{13} + \frac{1}{12}\right) = \frac{1}{78}$$
...
SOLUTION:
  ...
  - Now $$\mathbb{P}(T) = \mathbb{P}(\text{two even numbers}) = \mathbb{P}(\text{1st even})\mathbb{P}(\text{2nd even}) = \frac{1}{2}\frac{1}{2} = \frac{1}{4}$$.
  ...
  - We know that $$\mathbb{P}(A) = \frac{370}{4000}$$, and so from the tree diagram we get the equation: $$\frac{x}{4} + \frac{3(1-x)}{4} = \frac{2360}{4000}$$.
...
SOLUTION:
 ...
 - Using conditional probability we get that $$\mathbb{P}(\text{rollerblade} \mid \text{skaetboard}) = \frac{\mathbb{P}(\text{skateboard } \cap \text{ rollerblades})}{\mathbb{P}(\text{skateboard})} = \frac{0.36}{0.46} = \frac{18}{23}$$.
