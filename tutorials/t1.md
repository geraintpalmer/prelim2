...
Consider $$A$$ and $$B$$ to be general sets, and the universal set to be $$\Omega$$. State whether the following statements are true or false.
...
9. $$\lvert A \ B \rvert = \lvert B \ A \rvert$$.
